...
public class CriterioAction extends Action{
	String url="";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			if (parametro.equals("criterioPublic")) {
				forwardName =criterioPublic(mapping, form, request, response);
				System.out.println("Enviando al action :"+forwardName);
			}
...
"</html>";
	...
	private String criterioPublic(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
