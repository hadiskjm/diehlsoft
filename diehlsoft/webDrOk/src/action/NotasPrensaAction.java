...
public class NotasPrensaAction extends Action{
	String url="";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			if (parametro.equals("notasPrensaPublic")) {
				forwardName =notasPrensaPublic(mapping, form, request, response);
				System.out.println("Enviando al action :"+forwardName);
			}
...
"</html>";
	...
	private String notasPrensaPublic(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
