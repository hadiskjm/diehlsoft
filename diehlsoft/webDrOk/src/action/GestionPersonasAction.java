...
public class GestionPersonasAction extends Action{
	String url="";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			if (parametro.equals("gestionPersonasPublic")) {
				forwardName =gestionPersonasPublic(mapping, form, request, response);
				System.out.println("Enviando al action :"+forwardName);
			}
...
"</html>";
	...
	private String gestionPersonasPublic(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
	...
	private String aclSearch(ActionMapping mapping, ActionForm form,
		...
		int p_intaclId=0;
		ArrayList aclSearchList=aclservice.aclSearchList(p_intaclId);
	...
	private String actualidadLaboralSearch(ActionMapping mapping, ActionForm form,
		...
		BeanActualidadLaboral beanAcl=new BeanActualidadLaboral();
		beanAcl.setStraclNombre("%%");
		beanAcl.setStraclResumen("%%");
		beanAcl.setStraclEstado("%%");
