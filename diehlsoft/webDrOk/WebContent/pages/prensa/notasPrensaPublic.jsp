...
<body>
<html:form action="notasPrensaPublic.do" method="post" styleId="actualidadLaboralForm">
<div class="container bg1 clearfix">
  ...
  <fieldset class="borde">
	  ...
	  <logic:iterate name="actualidadLaboralForm" property="aclSearchListxestado" id="aclSearchListxestado">   
        <logic:match name="aclSearchListxestado" property="straclTitulo" value="5. NOTAS DE PRENSA">                      
