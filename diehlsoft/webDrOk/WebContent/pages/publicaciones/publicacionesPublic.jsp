...
<body>
<html:form action="publicacionesPublic.do" method="post" styleId="actualidadLaboralForm">
<div class="container bg1 clearfix">
   ...
   <fieldset class="borde">
	  ...
	  <logic:iterate name="actualidadLaboralForm" property="aclSearchListxestado" id="aclSearchListxestado">   
        <logic:match name="aclSearchListxestado" property="straclTitulo" value="6. PUBLICACIONES">                      
