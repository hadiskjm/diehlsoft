...
function save(){
	  var menunivel1Form = document.getElementById("menunivel1Form");
	  menunivel1Form.action="<%= request.getContextPath()%>/menunivel1Update.do?event=mecsaveUpdate";
	  menunivel1Form.submit();
	  }
...
<body>
<html:form action="menunivel1Update.do" method="post" styleId="menunivel1Form">
<div class="container bg2 clearfix">
    <div id="maincont" class="bodycontainer clearfix">

<!-- =================================================== -->
     <h3><bean:message key="menunivel1Form.mecUpdate.title"/></h3>
    <hr>
    <br>
    <fieldset>
    ...
    <div class="mainForm">
				...
				<fieldset>
				    <legend><bean:message key="menunivel1Form.mecUpdate.legend.general"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecNombreMenu"/>:</label>
                        ...
                        <label><bean:message key="menunivel1Form.mecUpdate.cbo.strmecLocale"/>:</label>
					    ...
					    <label><bean:message key="menunivel1Form.mecUpdate.cbo.strmecTipoSistema"/>:</label>
					    ...
					    <label><bean:message key="menunivel1Form.mecUpdate.txt.intmecNivelUsuario"/>:</label>
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecEvento"/>:</label>
						<html:text property="strmecEvento" styleId="strmecEvento" />
						<span  class="generalErrors"><html:errors property="strmecEvento"/></span>
						
						 <label><bean:message key="menunivel1Form.mecUpdate.cbo.strmecMuestraContenido"/>:</label>
					    ...
					    <div class="cbp-mc-column25">
					     ...
					     <label><bean:message key="menunivel1Form.mecUpdate.fle.strmecNombreImagen"/>:</label>
			           ...
			           <label>&nbsp;</label>
			            ...
			            <bean:message key='menunivel1Form.mecUpdate.btn.browser'/></html:button> 
			            
			            <label><bean:message key="menunivel1Form.mecUpdate.cbo.strmecEstado"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel1Form.mecUpdate.fle.strmecNombrePdf"/>:</label>
                        ...
                        <label><bean:message key="menunivel1Form.mecUpdate.txt.intmecPosicion"/>:</label>
                 ...
                 <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel1Form.mecUpdate.legend.twitter"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecTwitterCard"/>:</label>
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecTwitterSite"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
					    ...
					    <label><bean:message key="menunivel1Form.mecUpdate.txt.strmecTwitterTitle"/>:</label>
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecTwitterCreator"/>:</label>
					   ...
					   <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecTwitterImage"/>:</label>
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecTwitterDescription"/>:</label>
                  ...
                  <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel1Form.mecUpdate.legend.google"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecGoogleName"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecGoogleImage"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecGoogleDescription"/>:</label>
                 ...
                 <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel1Form.mecUpdate.legend.og"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecOgTitle"/>:</label>
						<html:text property="strmecOgTitle" styleId="strmecOgTitle" />
						<span  class="generalErrors"><html:errors property="strmecOgTitle"/></span>
						
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecOgSite_name"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecOgType"/>:</label>
						<html:text property="strmecOgType" styleId="strmecOgType" />
						<span  class="generalErrors"><html:errors property="strmecOgType"/></span>
						
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecOgUrl"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecOgImage"/>:</label>
						...
						<label><bean:message key="menunivel1Form.mecUpdate.txt.strmecOgDescription"/>:</label>
				...
				<fieldset>
				    <legend><bean:message key="menunivel1Form.mecUpdate.legend.general"/></legend>
					    ...
					    <div class="cbp-mc-column100">
						    ...
						    <label><bean:message key="menunivel1Form.mecUpdate.txt.strmecMenu"/>:</label>
    ...
    <BR>
            ...
            <bean:message key='menunivel1Form.mecUpdate.btn.save'/></html:submit> 
		     &nbsp;
			<html:button property="" styleClass="button green medium" onclick="cancel()" >
			<bean:message key='menunivel1Form.mecUpdate.btn.cancel'/></html:button>
	  
	<span>
    <logic:equal name="menunivel1Form" property="flagConfirm" value="ERROR">
	<script type="text/javascript">
	alert("<bean:message key="menunivel1Form.mecUpdate.error.error" /> <bean:write name="menunivel1Form" property="strmecNombreMenu"/>");
	</script>
