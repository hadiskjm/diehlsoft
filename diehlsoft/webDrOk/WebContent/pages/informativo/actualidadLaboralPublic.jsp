...
<body>
<html:form action="actualidadLaboralPublic.do" method="post" styleId="actualidadLaboralForm">
<div class="container bg1 clearfix">
  ...
  <fieldset class="borde">
	  ...
	  <logic:iterate name="actualidadLaboralForm" property="aclSearchListxestado" id="aclSearchListxestado">   
        <logic:match name="aclSearchListxestado" property="straclTitulo" value="4. COYUNTURA">                      
		...
		<div><p class="barra">ÁREA LABORAL</p></div>
		  ...
		  <ul>
		    ...
		    <li><a href="mailto:adelcampo@lazoabogados.com.pe">Alejandra del Campo</a></li>
		    ...
		    <li><a href="mailto:dvassallo@lazoabogados.com.pe">Diana Vassallo</a></li>
		  </ul>
		</div>
       </fieldset>
       <br>
