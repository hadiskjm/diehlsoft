...
<body>
<html:form action="actualidadLaboralVisor.do" method="post" styleId="actualidadLaboralForm">
<div class="container bg1 clearfix">
	...
	<!-- =================================================== -->
	  ...
	  <div>
              ...
              <logic:iterate name="actualidadLaboralForm" property="aclVisorBean" id="aclVisorBean">    
             <h6>&nbsp;&nbsp;<bean:write name="aclVisorBean" property="straclNombre"/></h6>       
             <html:html> ${aclVisorBean.straclContenido} </html:html>   
             <br>
             </logic:iterate>
