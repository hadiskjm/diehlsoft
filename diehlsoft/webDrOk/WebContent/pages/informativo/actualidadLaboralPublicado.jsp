...
<%@ page import="bean.*" %>
<% 
  BeanActualidadLaboral bean= (BeanActualidadLaboral)session.getAttribute("bean");
%>
<html>
<head>
...
<body>
<html:form action="actualidadLaboralPublicado.do" method="post" styleId="actualidadLaboralForm">
