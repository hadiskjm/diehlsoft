...
function save(){
	  var menunivel2Form = document.getElementById("menunivel2Form");
	  menunivel2Form.action="<%= request.getContextPath()%>/menunivel2Update.do?event=medsaveUpdate";
	  menunivel2Form.submit();
	  }
...
<body>
<html:form action="menunivel2Update.do" method="post" styleId="menunivel2Form">
<div class="container bg2 clearfix">
    <div id="maincont" class="bodycontainer clearfix">

<!-- =================================================== -->
     <h3><bean:message key="menunivel2Form.medUpdate.title"/></h3>
    <hr>
    <br>
    <fieldset>
    ...
    <div class="mainForm">
				...
				<fieldset>
				    <legend><bean:message key="menunivel2Form.medUpdate.legend.general"/></legend>
					<div class="cbp-mc-column25">
					    
					    <label><bean:message key="menunivel2Form.medUpdate.cbo.intmecId"/>:</label>
						<html:select property="intmecId">
					     <html:optionsCollection label="strmecNombreMenu" property="medListMenuNivel1" value="intmecId" />
					    </html:select>
					    
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedNombreMenu"/>:</label>
                        ...
                        <label><bean:message key="menunivel2Form.medUpdate.cbo.strmedLocale"/>:</label>
					    ...
					    <label><bean:message key="menunivel2Form.medUpdate.cbo.strmedTipoSistema"/>:</label>
					    ...
					    <label><bean:message key="menunivel2Form.medUpdate.txt.intmedNivelUsuario"/>:</label>
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedEvento"/>:</label>
						<html:text property="strmedEvento" styleId="strmedEvento" />
						<span  class="generalErrors"><html:errors property="strmedEvento"/></span>
						
						 <label><bean:message key="menunivel2Form.medUpdate.cbo.strmedMuestraContenido"/>:</label>
					    ...
					    <div class="cbp-mc-column25">
					     ...
					     <label><bean:message key="menunivel2Form.medUpdate.fle.strmedNombreImagen"/>:</label>
			           ...
			           <label>&nbsp;</label>
			            ...
			            <bean:message key='menunivel2Form.medUpdate.btn.browser'/></html:button> 
			            
			            <label><bean:message key="menunivel2Form.medUpdate.cbo.strmedEstado"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel2Form.medUpdate.fle.strmedNombrePdf"/>:</label>
                        ...
                        <label><bean:message key="menunivel2Form.medUpdate.txt.intmedPosicion"/>:</label>
                 ...
                 <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel2Form.medUpdate.legend.twitter"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedTwitterCard"/>:</label>
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedTwitterSite"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
					    ...
					    <label><bean:message key="menunivel2Form.medUpdate.txt.strmedTwitterTitle"/>:</label>
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedTwitterCreator"/>:</label>
					   ...
					   <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedTwitterImage"/>:</label>
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedTwitterDescription"/>:</label>
                  ...
                  <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel2Form.medUpdate.legend.google"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedGoogleName"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedGoogleImage"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedGoogleDescription"/>:</label>
                 ...
                 <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel2Form.medUpdate.legend.og"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedOgTitle"/>:</label>
						<html:text property="strmedOgTitle" styleId="strmedOgTitle" />
						<span  class="generalErrors"><html:errors property="strmedOgTitle"/></span>
						
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedOgSite_name"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedOgType"/>:</label>
						<html:text property="strmedOgType" styleId="strmedOgType" />
						<span  class="generalErrors"><html:errors property="strmedOgType"/></span>
						
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedOgUrl"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedOgImage"/>:</label>
						...
						<label><bean:message key="menunivel2Form.medUpdate.txt.strmedOgDescription"/>:</label>
				...
				<fieldset>
				    <legend><bean:message key="menunivel2Form.medUpdate.legend.general"/></legend>
					    ...
					    <div class="cbp-mc-column100">
						    ...
						    <label><bean:message key="menunivel2Form.medUpdate.txt.strmedMenu"/>:</label>
    ...
    <BR>
            ...
            <bean:message key='menunivel2Form.medUpdate.btn.save'/></html:submit> 
		     &nbsp;
			<html:button property="" styleClass="button green medium" onclick="cancel()" >
			<bean:message key='menunivel2Form.medUpdate.btn.cancel'/></html:button>
	  
	<span>
    <logic:equal name="menunivel2Form" property="flagConfirm" value="ERROR">
	<script type="text/javascript">
	alert("<bean:message key="menunivel2Form.medUpdate.error.error" /> <bean:write name="menunivel2Form" property="strmedNombreMenu"/>");
	</script>
