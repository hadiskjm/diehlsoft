...
<div >
	...
	<!-- Top Navigation Bar -->
		<div class="sb-navbar sb-slide">
		    ...
		    <h1><a href="http://www.drokhealthcare.com"><html:img styleClass="img100" border="0" page="/image/logodrokcorp.png"/></a></h1>
		</div>
  ...
  if(intnivelUser>2) {
	  %>
	 <jsp:include page="/pages/general/3c.jsp"></jsp:include>
	  <%
	  }
  else if(intnivelUser>1) {
  %>
 <jsp:include page="/pages/general/2c.jsp"></jsp:include>
  <%
  }else {
  %>
  
<jsp:include page="/pages/general/1c.jsp"></jsp:include>
  <%
  }
