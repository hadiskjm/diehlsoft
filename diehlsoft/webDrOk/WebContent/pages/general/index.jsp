...
<HTML>
	<HEAD>
		<TITLE>Eclipse BIRT Home Harold Rojas</TITLE>
	...
	<%
		...
		String viewerVersion = "2.6.2";
		String engineVersion = "2.6.2";
	%>
	</HEAD>
	<BODY>
		<!-- Page banner -->
			...
			<TBODY>
				<TR>
					<TD class=content style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" >
						...
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=prueba.rptdesign" %>">View Example</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=resumenParte.rptdesign" %>">View Example</a>
					</TD>
				</TR>
			</TBODY>
		</TABLE>
