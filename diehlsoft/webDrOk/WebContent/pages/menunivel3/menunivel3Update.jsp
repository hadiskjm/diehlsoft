...
function save(){
	  var menunivel3Form = document.getElementById("menunivel3Form");
	  menunivel3Form.action="<%= request.getContextPath()%>/menunivel3Update.do?event=metsaveUpdate";
	  menunivel3Form.submit();
	  }
function metFillMenu2(){
	  var menunivel3Form = document.getElementById("menunivel3Form");
	  menunivel3Form.action="<%= request.getContextPath()%>/menunivel3Update.do?event=metFillMenu2Update";
	  menunivel3Form.submit();
	  }
   </script>
...
<body>
<html:form action="menunivel3Update.do" method="post" styleId="menunivel3Form">
<div class="container bg2 clearfix">
    <div id="maincont" class="bodycontainer clearfix">

<!-- =================================================== -->
     <h3><bean:message key="menunivel3Form.metUpdate.title"/></h3>
    <hr>
    <br>
    <fieldset>
    ...
    <div class="mainForm">
				...
				<fieldset>
				    <legend><bean:message key="menunivel3Form.metUpdate.legend.general"/></legend>
					<div class="cbp-mc-column25">
					    
					    <label><bean:message key="menunivel3Form.metUpdate.cbo.intmecId"/>:</label>
					    ...
					    <label><bean:message key="menunivel3Form.metUpdate.cbo.intmedId"/>:</label>
						<html:select property="intmedId">
					     <html:optionsCollection label="strmedNombreMenu" property="metListMenuNivel2" value="intmedId" />
					    </html:select>
					    
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetNombreMenu"/>:</label>
                        ...
                        <label><bean:message key="menunivel3Form.metUpdate.cbo.strmetLocale"/>:</label>
					    ...
					    <label><bean:message key="menunivel3Form.metUpdate.cbo.strmetTipoSistema"/>:</label>
					    ...
					    <label><bean:message key="menunivel3Form.metUpdate.txt.intmetNivelUsuario"/>:</label>
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetEvento"/>:</label>
						<html:text property="strmetEvento" styleId="strmetEvento" />
						<span  class="generalErrors"><html:errors property="strmetEvento"/></span>
						
						 <label><bean:message key="menunivel3Form.metUpdate.cbo.strmetMuestraContenido"/>:</label>
					    ...
					    <div class="cbp-mc-column25">
					     ...
					     <label><bean:message key="menunivel3Form.metUpdate.fle.strmetNombreImagen"/>:</label>
			           ...
			           <label>&nbsp;</label>
			            ...
			            <bean:message key='menunivel3Form.metUpdate.btn.browser'/></html:button> 
			            
			            <label><bean:message key="menunivel3Form.metUpdate.cbo.strmetEstado"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel3Form.metUpdate.fle.strmetNombrePdf"/>:</label>
                        ...
                        <label><bean:message key="menunivel3Form.metUpdate.txt.intmetPosicion"/>:</label>
                 ...
                 <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel3Form.metUpdate.legend.twitter"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetTwitterCard"/>:</label>
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetTwitterSite"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
					    ...
					    <label><bean:message key="menunivel3Form.metUpdate.txt.strmetTwitterTitle"/>:</label>
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetTwitterCreator"/>:</label>
					   ...
					   <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetTwitterImage"/>:</label>
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetTwitterDescription"/>:</label>
                  ...
                  <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel3Form.metUpdate.legend.google"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetGoogleName"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetGoogleImage"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetGoogleDescription"/>:</label>
                 ...
                 <div class="cbp-mc-form">
				<fieldset>
				    <legend><bean:message key="menunivel3Form.metUpdate.legend.og"/></legend>
					<div class="cbp-mc-column25">
					
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetOgTitle"/>:</label>
						<html:text property="strmetOgTitle" styleId="strmetOgTitle" />
						<span  class="generalErrors"><html:errors property="strmetOgTitle"/></span>
						
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetOgSite_name"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetOgType"/>:</label>
						<html:text property="strmetOgType" styleId="strmetOgType" />
						<span  class="generalErrors"><html:errors property="strmetOgType"/></span>
						
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetOgUrl"/>:</label>
					  ...
					  <div class="cbp-mc-column25">
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetOgImage"/>:</label>
						...
						<label><bean:message key="menunivel3Form.metUpdate.txt.strmetOgDescription"/>:</label>
				...
				<fieldset>
				    <legend><bean:message key="menunivel3Form.metUpdate.legend.general"/></legend>
					    ...
					    <div class="cbp-mc-column100">
						    ...
						    <label><bean:message key="menunivel3Form.metUpdate.txt.strmetMenu"/>:</label>
    ...
    <BR>
            ...
            <bean:message key='menunivel3Form.metUpdate.btn.save'/></html:submit> 
		     &nbsp;
			<html:button property="" styleClass="button green metium" onclick="cancel()" >
			<bean:message key='menunivel3Form.metUpdate.btn.cancel'/></html:button>
	  
	<span>
    <logic:equal name="menunivel3Form" property="flagConfirm" value="ERROR">
	<script type="text/javascript">
	alert("<bean:message key="menunivel3Form.metUpdate.error.error" /> <bean:write name="menunivel3Form" property="strmetNombreMenu"/>");
	</script>
